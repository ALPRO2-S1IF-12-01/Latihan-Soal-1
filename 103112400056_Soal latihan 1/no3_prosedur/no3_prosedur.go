...
func tampilkanInfo(nama string, nim string, jurusan string) {
	...
	fmt.Printf("Nama    : %s\n", nama)
	fmt.Printf("Nim    : %s\n", nim)
 // (3) Lengkapi agar mencetak NIM dengan format yang benar
...
func main() {
	...
	tampilkanInfo("Ani Wijaya", "87654321",
"Sistem Informasi") // (8) Lengkapi agar memanggil prosedur tampilkanInfo dengan data yang sesuai
