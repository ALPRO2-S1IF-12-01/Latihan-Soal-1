...
func ubahNilai(nilai *int) {
	*nilai += 10
	fmt.Print("Nilai setelah diubah: ") // (4) Lengkapi agar mencetak nilai setelah diubah
}
...
func main() {
	...
	tampilkanInfo("Nufail Alauddin Tsaqif", "103112400084", "Teknik Informatika") // (8) Lengkapi agar memanggil prosedur tampilkanInfo dengan data yang sesuai
