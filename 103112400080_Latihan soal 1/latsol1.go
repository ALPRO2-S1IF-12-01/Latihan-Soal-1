...
func main() {
	...
	if nilai >= 90 {
		...
		fmt.Println("Nilai D")// (3) Lengkapi bagian ini untuk mencetak "Nilai E"
	}
	...
	counter := 1
	for counter <= 5 {
		fmt.Println("Iterasi ke-", counter)// (4) Lengkapi bagian ini untuk mencetak "Iterasi ke-X"
		counter++
	}
