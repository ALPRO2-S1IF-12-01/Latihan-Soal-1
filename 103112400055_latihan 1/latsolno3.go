...
func tampilkanHeader() {
	...
	fmt.Println("______________________________") // (2) Lengkapi untuk mencetak garis bawah
}
...
func main() {
	...
	tampilkanInfo("Ani Wijaya", "87654321", "Sistem Informasi") // (8) Lengkapi agar memanggil prosedur tampilkanInfo dengan data yang sesuai
