...
func main() {
    ...
    // Memanggil prosedur dengan slice parameter
    daftarMahasiswa := []string{"Budi", "Siti", "Joko", "Ani"}
    tampilkanDaftarMahasiswa(daftarMahasiswa) // Memanggil prosedur tampilkanDaftarMahasiswa
}
